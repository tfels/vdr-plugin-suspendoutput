...
#
# $Id: Makefile,v 1.11 2016/06/08 19:27:25 phintuka Exp $
...
OBJS_MPG = vdrlogo_720x576.o black_720x576.o
...
clean:
	...
	@-rm -f mpg2c black_720x576.c vdrlogo_720x576.c
	@-rm -f $(OBJS) $(OBJS_MPG) $(DEPFILE) *.so *.tgz core* *~
